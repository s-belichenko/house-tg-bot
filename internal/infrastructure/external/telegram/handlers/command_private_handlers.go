...
Команды в переписке с ботом:

/start – Начало работы с ботом. В домовом чате не требуется.
/help – Текущая справка.

Команды в домовом чате:

/keys – Шуточная команда, заставляющая бота ответить на вопрос "ПИК, где мои ключи?" Работает только в теме "Оффтоп".` +
		` Но осторожнее, половина соседей уже ненавидит эту команду.
/report – Сообщить о нарушении правил. Напишите ее в ответе на сообщение с нарушением правил чата, ` +
		`после команды через пробел можете уточнить причину жалобы, например:
