...
var (
	...
	BtnCopyInviteText = Selector.Data("Скопировать текст", "copy_invite_text")
	BtnOpenDialog     = Selector.Data("Открыть диалог", "open_dialog")
	BtnApprove        = Selector.Data("Одобрить заявку", "approve_user")
)
