...
- Уведомления о вступлении или выходе стали приходить только на домовой чат.
- Убран баг с уведомлением о попытке использования административных команд вне чата админов.
- В уведомлениях в чат админов идентификатор пользователя теперь можно легко скопировать.
- Более верная проверка использования команды `/report`.
- Обновлена документация.

# 1.21.0 – 27.12.2025

- Добавлена реакция на покидание пользователем чата. Предположительно, не работает в закрытых группах.
- Приветствие новичков вынесено в переменную окружения.
- Теперь в командах с указанием дней нельзя передать отрицательное число.
- Рефакторинг структуры проекта, начат переход на слоистую архитектуру.
- Новая команда `/my_info`.
- Новая команда `/self_mute`.
- Помарки после внедрения инструмента шаблонизации.
